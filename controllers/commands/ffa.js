...
exports.run = (client, message, args) => {
    ...
    switch(message.flags[0]) {
        ...
        case 'r':
            ...
            break
        case 'p':
            channel = ['468250799256895499','251971076077125633','376551253427093505','136222872371855360','269634154101080065'].includes(message.channel.id)
            referee = message.member._roles && (message.member._roles.includes('243949285438259201') || message.member._roles.includes('252700465521885185'))
            if(channel && referee) {
                pingList = ""
                count = 1
